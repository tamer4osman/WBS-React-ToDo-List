...
const OkCancelButtons = ({ okHandler, cancelHandler }) => {
  return (
    <div className="row">
      <div className="col btn-group">
        <button className="btn btn-success px-0" onClick={okHandler}>
        ...
        <button className="btn btn-danger p-0" onClick={cancelHandler}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
              fill="currentColor"
